...
The Sourcelabs project codes in this table come from the **Sourcelabs project codes** section in `rules/context.md`. If the default project code changes (e.g. a new deployment name), update both files together.
...
| `Amsterdam`       | `Amsterdam` | 8       | `Eneco-Stefania`            | 8                | unchecked              |
| `Rotterdam`       | `Rotterdam` | 8       | `Eneco-Stefania`            | 8                | unchecked              |
